...
class SolicitudController extends Controller
{
    ...
    {   
        ...
        //ADMINISTRADOR
        if (Auth::user()->rol_de_usuario_id == 1 or Auth::user()->rol_de_usuario_id == 9) {
        ...
        $groupBy = 's.id, s.hash, tipo_de_evento_fk, localidad_fk, s.monto_a_invertir, id.idioma, e.name, s.nombre_del_solicitante, s.sino_aprobado_administracion, s.sino_aprobado_solicitar_revision, s.sino_cancelada, s.sino_aprobado_finalizada, u.name';
    ...
    {   
        ...
        $campos_select = 's.id, s.hash, CONCAT(te.tipo_de_evento, " ", IFNULL(s.titulo_del_formulario_personalizado, "")) as tipo_de_evento_fk, IFNULL(CONCAT(l.localidad, ", ", p.provincia, ", ", pa.pais), IFNULL(CONCAT(s.escribe_tu_ciudad_sino_esta_en_la_lista_anterior, ", ", pa2.pais), pa2.pais)) as localidad_fk, id.idioma, s.monto_a_invertir, e.name as nombre_de_ejecutivo, s.nombre_del_solicitante, COUNT(i.id) inscripciones_cant, s.sino_aprobado_administracion, s.sino_aprobado_solicitar_revision, s.sino_cancelada, s.sino_aprobado_finalizada, u.name';
        $groupBy = 's.id, s.hash, tipo_de_evento_fk, localidad_fk, id.idioma, s.monto_a_invertir, e.name, s.nombre_del_solicitante, s.sino_aprobado_administracion, s.sino_aprobado_solicitar_revision, s.sino_cancelada, s.sino_aprobado_finalizada, u.name';
    ...
    {  
        ...
        if ($Solicitud->Tipo_de_evento->id == 4) {
            $gen_campos_a_ocultar = array('solicitud_id', 'url_enlace_a_google_maps_inicio', 'url_enlace_a_google_maps_curso', 'hora_lunes', 'hora_martes', 'hora_miercoles', 'hora_jueves', 'hora_viernes', 'hora_sabado', 'hora_domingo', 'sino_agotado', 'url_enlace_a_google_maps_inicio_redirect_final', 'url_enlace_a_google_maps_curso_redirect_final', 'latitud', 'longitud', 'fecha_de_inicio', 'hora_de_inicio', 'direccion_de_inicio', 'url_enlace_a_google_maps_inicio', 'cupo_maximo_disponible_del_salon', 'direccion_del_curso', 'url_enlace_de_invitacion_al_grupo_de_whatsapp_del_aula_virtual');
            $gen_seteo['no_mostrar_campos_abm'] = 'hora_lunes|hora_martes|hora_miercoles|hora_jueves|hora_viernes|hora_sabado|hora_domingo|direccion_del_curso|url_enlace_a_google_maps_curso|sino_agotado|url_enlace_a_google_maps_inicio_redirect_final|url_enlace_a_google_maps_curso_redirect_final|latitud|longitud|url_enlace_de_invitacion_al_grupo_de_whatsapp_del_aula_virtual|fecha_de_inicio|hora_de_inicio|direccion_de_inicio|url_enlace_a_google_maps_inicio|cupo_maximo_disponible_del_salon';
