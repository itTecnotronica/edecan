...
namespace App\Http\Controllers\Mautic\Auth;

use App\Http\Controllers\Mautic\Exception\AuthorizationRequiredException;
use App\Http\Controllers\Mautic\Exception\IncorrectParametersReturnedException;
