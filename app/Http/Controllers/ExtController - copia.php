...
class ExtController extends Controller
{
    ...
    public function crearFlyer($solicitud_id, $template) {
        ...
        $img->save(env('PATH_PUBLIC_INTERNO').'img/nando-1.jpg', 100);
        //$img->response();
    ...
    public function saveWabot(Request $request) {
        ...
        if ($palabra_clave == 'gnosis_in' or $palabra_clave == 'gnosis_in_pt' or $palabra_clave == 'gnosis_inscripcion' or $palabra_clave == '#gnosis_inscripcion') {
        ...
        if ($palabra_clave == 'gnosis_pre' or $palabra_clave == 'gnosis_pre_pt') {
