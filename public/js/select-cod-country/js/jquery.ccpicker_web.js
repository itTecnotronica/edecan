...
(function(factory) {
  ...
  var defaults = {
    ...
    dataUrl: "https://ac.gnosis.is/data/paises-cod-tel",
	countryFilter: true,
  ...
  $.extend(CcPicker.prototype, {
    init: function () {
      ...
      this._ccPicker = $('<div class="cc-picker cc-picker-code-select-enabled form-control"  style="width: 20%; min-width: 100px; float: left">').insertBefore(this.element);
