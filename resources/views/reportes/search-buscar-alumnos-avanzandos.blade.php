...
@section('contenido')
  ...
  <link rel="stylesheet"
    ...
    <section class="content-header">
      <h1>
        <?php echo __('Buscar') ?> <?php echo __('Alumnos avanzados') ?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="box-body">
          ...
          <div class="col-lg-3 col-xs-12">
            <div class="form-group">
              <label><?php echo __('ID') ?> <?php echo __('Alumno Avanzado') ?></label>
              <input type="text" name="alumno_avanzado_id" id="alumno_avanzado_id" class="form-control">
            </div>
          ...
          <div class="col-lg-3 col-xs-12">
            ...
            <div class="form-group">
              <label><?php echo __('Estado de Seguimiento') ?></label>
              <?php $estados_de_seguimiento = App::make('App\Http\Controllers\HomeController')->get_estados_de_seguimiento();?>
              <?php echo Form::select("estado_de_seguimiento_id", $estados_de_seguimiento, null, ['id' => "estado_de_seguimiento_id", 'class' => 'form-control select2', 'style' => 'width: 100%;']); ?>
            </div>

            <div class="form-group">
              <label><?php echo __('') ?></label>
              <input type="text" name="estado_de_seguimiento_id" id="estado_de_seguimiento_id" class="form-control">
            </div>
            <div class="form-group">
...
<script type="text/javascript">
  ...
  function traerListado() {
    ...
    $.ajax({
      url: '<?php echo env('PATH_PUBLIC') ?>listar-alumnos-avanzados',
      type: 'POST',
      dataType: 'html',
      async: true,
      data:{
        _token: "{{ csrf_token() }}",
        alumno_avanzado_id: $('#alumno_avanzado_id').val(),
        estado_de_seguimiento_id: $('#estado_de_seguimiento_id').val(),
