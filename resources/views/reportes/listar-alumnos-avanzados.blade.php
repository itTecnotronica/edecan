              ...
              <table id="lista-de-solicitudes" class="table table-hover" style="max-width: 500px" >
                <thead>
                  <tr>
                    ...
                    <th><?php echo __('Alumno avanzado') ?> <?php echo __('ID') ?></th>
                    <th><?php echo __('Estado de seguimiento') ?></th>
                    <th><?php echo __('Cantidad') ?> <?php echo __('Lecciones') ?></th>
                    <th><?php echo __('Ultima leccion vista') ?></th>
                    <th><?php echo __('Cantidad') ?> <?php echo __('Evaluaciones') ?></th>
                ...
                <tbody>                  
                  <?php foreach ($Inscripciones as $Inscripcion) { ?>
                    <tr>
                      <td><a href="<?php echo env('PATH_PUBLIC')?>f/iinscripto/<?php echo $Inscripcion->solicitud_id ?>/<?php echo $Inscripcion->iid ?>/<?php echo $Inscripcion->hash ?>" target="_blank"><button type="button" class="btn btn-sm btn-primary"><i class="fa fa-file-text-o"></i></button></td>
                      <td><?php echo $Inscripcion->aaid ?></td>
                      <td><?php echo $Inscripcion->estado_de_seguimiento ?></td>       
                      <td><?php echo $Inscripcion->cantidad_de_asistencias ?></td>
                      <td><?php echo $Inscripcion->nombre_de_la_leccion ?></td>
                      <td><?php echo $Inscripcion->cantidad_de_evaluaciones ?></td>
                      <td><?php echo $Inscripcion->iid ?></td>
