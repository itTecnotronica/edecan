          ...
          <div class="box">
            ...
            <div class="col-xs-6 col-lg-2" style="margin-bottom: 20px">  
                ...
                <div class="col-xs-12 col-lg-12">
                  ...
                  <div class="alert alert-success  alert-dismissible">
                    ...
                    <div class="btn-group">
                      ...
                      ?>
                      <a href="<?php echo env('PATH_PUBLIC')?>f/ipaginar/<?php echo $Solicitud->id ?>/<?php echo $Solicitud->hash ?>/<?php echo $j ?>">
                    ...
                    ?>
                    <a href="<?php echo env('PATH_PUBLIC')?>f/ipaginar/<?php echo $Solicitud->id ?>/<?php echo $Solicitud->hash ?>/all">
              ...
              <div class="col-xs-12 col-lg-12">
                {!! Form::open(array
                  (
                  'url' => env('PATH_PUBLIC').'f/ibuscar/'.$Solicitud->id.'/'.$Solicitud->hash, 
                  'role' => 'form',
                  'method' => 'POST',
                  'id' => "form_gen_modelo",
            ...
            ?>
              ...
              <div class="col-xs-12 col-lg-12 alert alert-danger alert-dismissible">
                <h4><i class="fa fa-thumbs-o-up"></i> <?php echo $mensajes[0] ?> </h4>  
              </div>
              <?php
                }
              }
                      ...
                      ?>
                        ...
                        <tr v-show="mostrarFila(<?php echo $i ?>)" v-bind:style="class_promocionado(estados[<?php echo $i ?>].promocionado)">
                            ...
                            <td v-show="show_col_comprimido">
                                    ...
                                    <li data-toggle="modal" data-target="#modal-fecha-de-evento" onclick="$('#inscripcion_id_modificar_fecha').val(<?php echo $Inscripcion->id ?>);" style="padding: 5px; cursor: pointer;"><a><?php echo __('Modificar') ?> <?php echo __('Fecha') ?></a>
                                      ...
                                      <?php if ($tipo_de_evento_id == 3 and $tipo_de_evento_id == 3) { ?>
                                        <!--li style="padding: 5px; cursor: pointer;">
                                          <a href="<?php echo env('PATH_PUBLIC')?>forzar-promocion/<?php echo $Inscripcion->id ?>"><?php echo __('Promocionar a Cámara Avanzada') ?></a>
                                        </li-->
                                      <?php } ?>
                                  <?php } ?>
                                  <li>
                                    <a href="<?php echo env('PATH_PUBLIC')?>f/contactDown/<?php echo $Solicitud->id; ?>/inscripcion/<?php echo $Inscripcion->id; ?>/1/1/<?php echo $Solicitud->hash; ?>" target="_blank">
                              ...
                              <strong style="color: blue"><?php echo __('Codigo del alumno') ?>: <?php echo $Inscripcion->codigo_alumno ?></strong><br>
                              ...
                              <?php 
                              if ($Inscripcion->fecha_de_evento_id > 0) {
                                echo $fecha_de_evento->armarDetalleFechasDeEventos('html', true, $Idioma_por_pais, $Solicitud, $idioma).'<br>'; 
                              }
                              else {
                                if ($Solicitud->tipo_de_evento_id <> 3 or ($Solicitud->tipo_de_evento_id == 3 and $Solicitud->tipo_de_curso_online_id == 4)) {
                            ...
                            <td v-show="show_col_fecha_de_evento">
                              <?php 
                              if ($Inscripcion->fecha_de_evento_id > 0) {
                                echo $fecha_de_evento->armarDetalleFechasDeEventos('html', true, $Idioma_por_pais, $Solicitud, $idioma); 
                              }
                              else {
                            ...
                            <?php if ($Inscripcion->fecha_de_evento_id > 0 and $tipo_de_evento_id <> 3) { ?>
                                  ...
                                  <?php if ($Inscripcion->enviarRecordatorioProxClase($fecha_de_evento)) { ?>
                            ...
                            <?php } ?>  
                              ...
                              <!-- ENVIO MODELOS EXTRA -->
                                <?php if (isset($Inscripcion->Modelos_extra) and !$promocionado) { ?>
                                  <div class="box box-primary box-solid collapsed-box" style="border-radius: 10px; border-color: #FFF">
                                    <div class="box-header with-border" data-widget="collapse" style="cursor: pointer; ;border-radius: 10px; background-color: #546772">
                              ...
                              <div v-show="estados[<?php echo $i ?>].promocionado || estados[<?php echo $i ?>].certificado" v-bind:class="class_sino(estados[<?php echo $i ?>].envio_certificado)">
                                  ...
                                  <a href="<?php echo $Inscripcion->url_certificado() ?>" target="_blank"><img src="<?php echo env('PATH_PUBLIC')?>img/certified.png" style="width: 30px; vertical-align: middle;"></a><?php echo __('Envio de certificado') ?>
                            ...
                            <td v-show="!estados[<?php echo $i ?>].promocionado && mensaje_extra != ''">
                              ...
                              <!-- ENVIO DE MENSAJE EXTRA x WHATSAPP -->   
                                ...
                                <p>
                                  <a v-show="enviar_mail" data-toggle="modal" data-target="#modal-confirmar-mail" v-on:click="preparar_envio_mail(23, '<?php echo $nombre; ?>', '<?php echo $apellido; ?>', <?php echo $Inscripcion->id ?>, '<?php echo __('Comunicado') ?>: <?php echo $Solicitud->tipo_de_evento->tipo_de_evento; ?>', <?php echo $i ?>)">
                                    <button type="button" class="btn btn-primary" alt="enviar" title="enviar"><i class="fa fa-envelope-o"></i> <?php echo __('Enviar via Email') ?></button>
                                  </a>
                                </p>
                            </td>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" id="modal-bodi-downcontactos"> 
                ...
                <form role="form">
                  ...
                  <a v-show="valor_select_contactdown == 'todos'" href="<?php echo env('PATH_PUBLIC')?>f/contactDown/<?php echo $Solicitud->id; ?>/todos/0/1/9999999/<?php echo md5(ENV('PREFIJO_HASH').$Solicitud->id) ?>">
                ...
                <table class="table table-striped">
                  <tbody>
                    ...
                    <tr v-for="grupo in grupos">
                      <td><?php echo __('Grupo') ?>: @{{ grupo.id }}</td>
                      <td> 
            ...
            var app = new Vue({
              ...
              data: {
                ...
                foreach ($Inscripciones as $Inscripcion) { 
                  ...
                  if ($Inscripcion->fecha_de_evento_id <> '') {
                    ...
                    $fecha_de_inicio = 'moment("'.$fecha_de_evento->fecha_de_inicio.'").format("DD/MM/YYYY")';
                  }
                ...
                causas_de_cambio_de_solicitud: [
                    { causa_de_cambio_de_solicitud: '', id: 0},
                  <?php 
              ...
              methods: { 
                ...
                guardarObs: function (i) {
                  app["estados"][i].obs_status_save = '<img src="<?php echo env('PATH_PUBLIC')?>img/cargando.gif" width="30px">'
                  observaciones=encodeURI(this.estados[i].observaciones)
                  if (observaciones == '') {
                    observaciones='XXNADAXX'
                  }
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/guardar-obs/'+this.estados[i].inscripcion_id+'/'+observaciones,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                guardarCel: function (i) {
                  app["estados"][i].celular_status_save = '<img src="<?php echo env('PATH_PUBLIC')?>img/cargando.gif" width="30px">'
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/guardar-cel/'+this.estados[i].inscripcion_id+'/'+this.estados[i].celular,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                guardarGrupo: function (i, id) {
                  app["estados"][i].grupo_status_save = '<img src="<?php echo env('PATH_PUBLIC')?>img/cargando.gif" width="30px">'
                  app["estados"][i].grupo = id
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/guardar-grupo/'+this.estados[i].inscripcion_id+'/'+id,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                guardarDatosGrupo: function (grupo_id, id, celular_responsable_de_inscripciones, nombre_responsable_de_inscripciones) {
                  app["datos_grupo_status_save"] = '<img src="<?php echo env('PATH_PUBLIC')?>img/cargando.gif" width="30px">'
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/guardar-datos-grupo',
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                modificarCausaDeBaja:  function (i) {
                  app["estados"][i].causa_de_baja_status_save = '<img src="<?php echo env('PATH_PUBLIC')?>img/cargando.gif" width="30px">'
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/baja-de-alumno/'+this.estados[i].inscripcion_id+'/'+this.estados[i].causa_de_baja_id,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                setearSino: function (codigo, i, inscripcion_id, estado_i = null) {
                  ...
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/setear-sino/'+codigo+'/'+inscripcion_id,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                procesar_envio_mail: function () {
                  ...
                  if (this.email_codigo == 23) {
                    ...
                    mensaje = mensaje.replace('inscrito_nombre', this.email_nombre)
                    mensaje = mensaje.replace('inscrito_apellido', this.email_apellido)   
                    mensaje = mensaje.replace('tel_responsable_inscripcion', '<?php echo $tel_responsable_inscripcion ?>')   
                  ...
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/inscripcion/enviar-email/'+this.email_inscripcion_id+'/'+this.email_codigo+'/'+this.limpiarCadena(this.email_asunto),
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                traerLeccionesVistas: function (inscripcion_id, hash) {
                  ...
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>traer-lecciones-vistas/'+inscripcion_id+'/'+hash,
                    type: 'GET',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                traerTPRealizados: function (inscripcion_id, hash) {
                  ...
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>traer-tp-realizados/'+inscripcion_id+'/'+hash,
                    type: 'GET',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                marcar_envio: function (medio_de_envio_id, codigo, i, inscripcion_id) {
                  ...
                  console.log('paso 3')
                  $.ajax({
                    url: '<?php echo env('PATH_PUBLIC')?>f/i/registrar-envio/'+codigo+'/'+inscripcion_id+'/'+medio_de_envio_id,
                    type: 'POST',
                    dataType: 'html',
                    async: true,
                    data:{
                ...
                url_mensa_extra: function (celular, nombre, apellido, codigo_del_alumno) {
                  ...
                  mensaje = mensaje.replace('codigo_del_alumno', codigo_del_alumno)
                ...
                mostrar_supero_cupo: function () {
                  var mostrar = false
                  for (i = 0; i < this.fechas_de_evento.length; i++) { 
                    console.log(this.fechas_de_evento[i].id)
                    if (this.fechas_de_evento[i].id != 'todos' && this.fechas_de_evento[i].id != -1 && this.supero_cupo(this.fechas_de_evento[i].id)[0]) {
                      mostrar = true
                    }
                  }
                  console.log(mostrar)
                ...
                supero_cupo: function (id) {
                  ...
                  if (this.fechas_de_evento[j].cupo_maximo < cant) {

                    capacidad_max_estimada_confirmados = parseInt(this.fechas_de_evento[j].cupo_maximo*100/70);
                    texto_exedio_capacidad = '<?php echo __('La cantidad de confirmados supera a la capacidad del salon, nuestras estadísticas nos permiten saber que el 70% de los confirmados son los que asisten, ud. podria llegar a confirmar hasta') ?>'+' "'+capacidad_max_estimada_confirmados+'" '+'<?php echo __('personas') ?>'

                    excedio = true
                    mensaje = '<?php echo __('Cupo excedido, cupo máximo') ?>'+': '+this.fechas_de_evento[j].cupo_maximo+' '+'<?php echo __('Confirmados') ?>'+': '+ cant +' | '+texto_exedio_capacidad
                  }
                  else {
                    excedio = false
                  }
                ...
                crearListasDeContactos: function () {
                  ...
                  for (i = cant_listas; i >= 1; i--) { 
                    j++
                    this.listas_de_contactos.push({titulo: 'Grupo '+i, url: '<?php echo env('PATH_PUBLIC')?>f/contactDown/<?php echo $Solicitud->id; ?>/pagina/'+j+'/1/'+this.cant_x_pagina+'/<?php echo $Solicitud->hash; ?>'})
                    }
                },
                

                urlgrupo: function (nro_de_grupo) {
                 url = '<?php echo env('PATH_PUBLIC')?>f/contactDown/<?php echo $Solicitud->id; ?>/grupo/'+nro_de_grupo+'/1/9999999/<?php echo md5(ENV('PREFIJO_HASH').$Solicitud->id) ?>'
                 return url
                },
