                                          ...
                                          <div class="checkbox">
                                            <label>
                                              {!! 
                                                Form::input(
                                                  'checkbox',
                                                  'sino_notificar_proximos_eventos', 
                                                  Input::old('sino_notificar_proximos_eventos'), 
                                                  array(
                                                    'id' => 'sino_notificar_proximos_eventos',
                                                    'v-model' => 'sino_notificar_proximos_eventos',
                                                    'data-vv-as' => __('Me gustaría recibir información sobre los próximos cursos y eventos gratuitos'),
                                                    'v-bind:disabled' => 'desabilitar'
                                                  )
                                                ) 
                                              !!}    
                                              <?php echo __('Me gustaría recibir información sobre los próximos cursos y eventos gratuitos') ?>
                                              <div class="bg-danger" id="_sino_notificar_proximos_eventos">{{$errors->first('sino_notificar_proximos_eventos')}}</div>  
                                            </label>
                                          </div>
                                        </div>
                                          ...
                                          <div class="checkbox">
                                            <label>
                                              {!! 
                                                Form::input(
                                                  'checkbox',
                                                  'acepto_politica_de_privacidad', 
                                                  Input::old('acepto_politica_de_privacidad'), 
                                                  array(
                                                    'id' => 'acepto_politica_de_privacidad',
                                                    'v-model' => 'acepto_politica_de_privacidad',
                                                    'data-vv-as' => __('Acepto la política de privacidad'),
                                                    'required' => $required,
                                                    'v-bind:disabled' => 'desabilitar'
                                                  )
                                                ) 
                                              ...
                                              <div class="bg-danger" id="_acepto_politica_de_privacidad">{{$errors->first('acepto_politica_de_privacidad')}}</div>  
