                                    ...
                                    <fieldset>
                                        ...
                                        <?php if (($Solicitud->sino_habilitar_pedido_de_canal_de_recepcion_del_curso == 'SI' and $Solicitud->tipo_de_evento_id == 3) or $Solicitud->id == 6 ) { ?>
                                          <div class="form-group required">
                                            ...
                                            <?php echo Form::select("canal_de_recepcion_del_curso_id", $Canales, 1, ['id' => "canal_de_recepcion_del_curso_id", 'class' => 'form-control', 'required' => 'required', 'v-model' => 'canal_de_recepcion_del_curso_id', 'v-validate' => "'required'", 'data-vv-as' => __('En que app te gustaria recibir el curso')]); ?>      
                                            <span v-show="errors.has('canal_de_recepcion_del_curso_id')" class="text-danger">@{{ errors.first('canal_de_recepcion_del_curso_id') }}</span>
                                          </div>
                                        <?php } ?>
