                                        ...
                                        <!-- INFO DEL CURSO -->
                                          <?php if ($Solicitud->sino_ocultar_informacion_del_curso_predeterminado <> 'SI' and ($Solicitud->institucion_id <> '2')) { ?>
                                            ...
                                            <div class="form-group">
                                              <!-- BOTON INSCRIBIRME 2 -->
                                                <center>
                                                  <button type="submit" class="btn btn-primary btn-lg" v-bind:disabled="desabilitar"> <?php echo __('Inscribirme') ?> </button>
                                                </center>
                                              <!-- BOTON INSCRIBIRME 2 -->
                                            </div><br><br>
                                        ...
                                        <!-- INFO DATOS MOBILE -->
                                          <div class="panel-body visible-xs hidden-lg hidden-md hidden-sm">
                                            <?php if($url_redes['url_youtube'] <> '') { ?>
                                              <!--center>
                                                <a href="<?php echo $url_redes['url_youtube'] ?>?sub_confirmation=1" target="_blank">
                                                  <button type="button" class="btn btn-warning" style="background-color: #ff0000"><?php echo __('Suscribete a nuestro Youtube') ?></button>
                                                </a><br>
                                              <?php echo _('para acceder a todos nuestros videos') ?><br><br>
                                              </center-->
                                            <?php } ?>
