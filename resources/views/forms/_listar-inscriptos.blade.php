            ...
            var app = new Vue({
              ...
              methods: { 
                ...
                mostrar_supero_cupo: function () {
                  var mostrar = false
                  console.log('this.fechas_de_evento[i]: '+this.fechas_de_evento[3].id)

                  for (i = 0; i < this.fechas_de_evento.length; i++) {
                    if (this.fechas_de_evento[i] != null) {
                      
                      supero_cupo_res = this.supero_cupo(this.fechas_de_evento[i].id) 
                      supero_cupo_excedio = supero_cupo_res[0]
                      console.log('supero_cupo_excedio: '+supero_cupo_excedio)
                    }
                    else {
                      supero_cupo_excedio = false
                    }


                    //console.log(this.fechas_de_evento[i].id)
                    if (this.fechas_de_evento[i].id != 'todos' && this.fechas_de_evento[i].id != -1 && supero_cupo_excedio) {
                      mostrar = true
                    }
                  }
                ...
                supero_cupo: function (id) {
                  ...
                  console.log('this.fechas_de_evento[j].cupo_maximo: '+this.fechas_de_evento[j].cupo_maximo)
