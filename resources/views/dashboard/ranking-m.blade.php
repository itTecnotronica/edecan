  ...
  <section class="content-header">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title"><?php echo __('Estadísticas') ?></h3>
      </div>
          ...
          ?>
            <div class="col-lg-3 col-xs-12">
              ...
              <div class="small-box bg-aqua" data-toggle="tooltip" data-trigger="hover" data-original-title="<?php echo __('Cantidad de Inscriptos en cursos on line por ciudad') ?>: <?php echo $periodo_mostrar ?>">
                ...
                <?php } ?>
                      <button type="button" class="btn btn-block btn-info" data-toggle="modal" data-target="#modal-cant2"><?php echo __('Lista Completa') ?></button>              
              </div>
            </div>

            <!-- MODAL CURSOS ONLINE PAIS -->
              <div class="modal fade" id="modal-cant2">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
