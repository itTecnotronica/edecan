...
<head>
    ...
    <!-- Title Page-->
    <title>Gnosis | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?></title>
            ...
            <div class="card card-4">
                <div class="card-body">
                  <div class="row">
                    ...
                    <center><h2 class="title"><?php echo e(__('Detalle del certificado')); ?><br><?php echo $Inscripcion->nombre; ?> <?php echo $Inscripcion->apellido; ?></h2></center>
                    <center><h4><?php echo e(__('Numero de certificado')); ?>: <?php echo $Inscripcion->id; ?></h4></center>
                    </div>
