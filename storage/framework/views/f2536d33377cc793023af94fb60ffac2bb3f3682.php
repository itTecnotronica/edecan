...
<meta charset="utf-8">
    ...
    <meta name="description" content="Gnosis | <?php echo e(__('Certificado')); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>">
    <meta name="author" content="gnosis.is">
    <meta name="keywords" content="Gnosis | <?php echo e(__('Certificado')); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?> ">
    <meta property="og:title" content="Gnosis | <?php echo e(__('Certificado')); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>" />
    <meta property="og:url" content="https://www.gnosis.is" />
    <meta property="og:description" content="Gnosis | <?php echo e(__('Certificado')); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>">
    ...
    <!-- Title Page-->
    <title>Gnosis | <?php echo e(__('Certificado')); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?></title>
