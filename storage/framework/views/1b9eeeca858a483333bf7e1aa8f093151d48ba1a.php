...
<head>
    ...
    <meta name="description" content="<?php echo $nombre_institucion ?> | <?php echo e($denominacion_de_voucher); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>">
    <meta name="author" content="<?php echo $nombre_institucion ?>.is">
    <meta name="keywords" content="<?php echo $nombre_institucion ?> | <?php echo e($denominacion_de_voucher); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?> ">
    <meta property="og:title" content="<?php echo $nombre_institucion ?> | <?php echo e($denominacion_de_voucher); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>" />
    <meta property="og:url" content="https://www.<?php echo $nombre_institucion ?>.is" />
    <meta property="og:description" content="<?php echo $nombre_institucion ?> | <?php echo e($denominacion_de_voucher); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?>">
    ...
    <!-- Title Page-->
    <title><?php echo $nombre_institucion ?> | <?php echo e($denominacion_de_voucher); ?> | <?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?></title>
                ...
                <div class="card-body">
                  ...
                  <div class="col-xs-12 col-md-6 col-lg-3">
                    <center>
                      ...
                      <p class="tit1_voucher"><?php echo e($nombre_de_la_institucion); ?> </p>
                      <p class="tit3_voucher"><?php echo e($denominacion_de_voucher); ?></p>
                      <p class="tit2_voucher"><?php echo e(__($Inscripcion->solicitud->tipo_de_evento->tipo_de_evento)); ?></p> 
                    </center>
                  </div>
