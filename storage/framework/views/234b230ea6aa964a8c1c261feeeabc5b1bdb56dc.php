                                ...
                                <fieldset>
                                    ...
                                    <!-- NOMBRE -->
                                      <div class="form-group required">
                                        ...
                                        <div class="bg-danger" id="_nombre"><?php echo e($errors->first('nombre')); ?></div>
                                      </div>
                                    <!-- NOMBRE -->
                                    ...
                                    <!-- APELLIDO -->
                                      <div class="form-group required">
                                        ...
                                        <div class="bg-danger" id="_apellido"><?php echo e($errors->first('apellido')); ?></div>
                                      </div>
                                    <!-- APELLIDO -->
                                      ...
                                      <?php if ($Solicitud->tipo_de_evento_id == 3 or ($Solicitud->tipo_de_evento_id == 4 and $Solicitud->pais_id == '') or ($Solicitud->tipo_de_evento_id == 4 and !in_array($Solicitud->id, array(3747, 4033)) ) )  { ?>
                                        ...
                                        <!-- PAIS -->
                                          <div class="form-group required">
                                            ...
                                            <div class="bg-danger" id="_pais_id"><?php echo e($errors->first('pais_id')); ?></div>
                                          </div>
                                        <!-- PAIS -->
                                        ...
                                        <!-- CIUDAD -->
                                          <div class="form-group required">
                                            ...
                                            <div class="bg-danger" id="_ciudad"><?php echo e($errors->first('ciudad')); ?></div>
                                          </div>
                                        <!-- CIUDAD -->
                                    ...
                                    <!-- CELULAR -->
                                      <div class="form-group <?php echo $cel_requerido_class ?>">
                                        ...
                                        <div class="bg-danger" id="_celular"><?php echo e($errors->first('celular')); ?></div>
                                      </div>
                                    <!-- CELULAR -->
                                    ...
                                    <!-- EMAIL -->
                                      <div class="form-group <?php echo $mail_requerido_class ?>">
                                        ...
                                        <div class="bg-danger" id="_email_correo"><?php echo e($errors->first('email_correo')); ?></div>
                                      </div>
                                    <!-- EMAIL -->
                                    ...
                                    <!-- LOCALIDAD | RECOLECCION DE DATOS-->
                                      <?php if ($Solicitud->tipo_de_evento_id == 4 and $Solicitud->pais_id <> '' and in_array($Solicitud->id, array(3747, 4033)) ) { ?>
                                        <div class="form-group required">
                                          ...
                                          <div class="bg-danger" id="_localidad_id"><?php echo e($errors->first('localidad_id')); ?></div>
                                        </div>
                                      <?php } ?>
                                    <!-- LOCALIDAD | RECOLECCION DE DATOS -->
