      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="modal-bodi-abm">
          ...
          <div class="panel-body">
              <form class="form-horizontal" method="POST" action="<?php echo e(url(ENV('PATH_PUBLIC').'change-password')); ?>">
                  <?php echo e(csrf_field()); ?>


                  <div class="form-group<?php echo e($errors->has('mypassword') ? ' has-error' : ''); ?>">
                      ...
                      <div class="col-md-6">
                          ...
                          <?php if($errors->has('mypassword')): ?>
                              <span class="help-block">
                                  <strong><?php echo e($errors->first('mypassword')); ?></strong>
                              </span>
                          <?php endif; ?>
                      </div>
                  </div>
