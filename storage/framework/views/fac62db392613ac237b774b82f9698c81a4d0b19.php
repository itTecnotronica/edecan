                ...
                <?php if($Solicitud->tipo_de_evento_id == 1 or $Solicitud->tipo_de_evento_id == 2 or ($Solicitud->tipo_de_evento_id == 3 and $Solicitud->tipo_de_curso_online_id == 4) or ($Solicitud->tipo_de_evento_id == 4 and $Fechas_de_eventos->count() > 0) ): ?>
                  ...
                  <div class="bg-white dark:bg-white/5 p-3 rounded-2xl border-4 border-[#8430ce] dark:border-gnosis-gold/30 shadow-2xl dark:shadow-lg transition-all transform hover:scale-[1.01] duration-300">
                    ...
                    <div class="space-y-1">
                      ...
                      <?php if($Solicitud->tipo_de_evento_id == 1 or ($Solicitud->tipo_de_evento_id == 2 and $Solicitud->cant() == 1) or ($Solicitud->tipo_de_evento_id == 3 and $Solicitud->tipo_de_curso_online_id == 4) or ($Solicitud->tipo_de_evento_id == 4 and $Fechas_de_eventos->count() > 0)): ?>
                        <?php                      
                        $type_opcion = 'radio';
                      ...
                      <!-- RECORRO LAS FECHAS DE EVENTOS -->
                        <?php $__currentLoopData = $Fechas_de_eventos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Fecha_de_evento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                          <?php if($Solicitud->tipo_de_evento_id == 1 or ($Solicitud->tipo_de_evento_id == 2 and $Solicitud->cant() == 1) or ($Solicitud->tipo_de_evento_id == 3 and $Solicitud->tipo_de_curso_online_id == 4) or ($Solicitud->tipo_de_evento_id == 4 and $Fechas_de_eventos->count() > 0)): ?>
                              <?php  $nombre_campo = 'fecha_de_evento_id';  ?>
                          <?php else: ?>
                              <?php  $nombre_campo = 'fecha_de_evento_id_'.$Fecha_de_evento->id;  ?>
                          <?php endif; ?>
                          ...
                          <label class="flex items-start gap-3 p-2 rounded-xl border-2 border-[#8430ce] hover:border-gnosis-accent dark:border-white/10 dark:hover:border-gnosis-gold bg-slate-50 dark:bg-black/40 cursor-pointer transition-all group hover:shadow-md">
                              <input type="radio" id="fecha_de_evento_id" name="<?php echo e($nombre_campo); ?>" value="<?php echo e($Fecha_de_evento->id); ?>" class="mt-1 w-4 h-4 text-gnosis-accent focus:ring-gnosis-accent border-gray-300 dark:border-gray-500 dark:bg-gray-700 dark:checked:bg-gnosis-gold" checked>
                              <div class="flex flex-col">
                                  ...
                                  <?php echo nl2br($Fecha_de_evento->armarDetalleFechasDeEventos($tipo, $con_inicio, $idioma_por_pais, $Solicitud, $idioma, $ver_mapa, $con_dir_inicio_distinto)); ?>
