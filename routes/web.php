...
Route::post('/f/i/guardar-mensaje-a-enviar', 'FormController@guardarMensajeAEnviar');
...
Route::get('/mostrar-flyers/{solicitud_id}', 'ExtController@mostrarFlyers');
...
Route::get('/espacioDeUsuario', "EspacioDeUsuario@mostrar");	
Auth::routes();

Route::get('/ejemplo', 'AlumnosHomeController@ejemplo');

Route::post('ajax-request', 'AppController@store');

Route::prefix('alumnos')
    ->as('alumnos.')
    ->group(function() {
        
        Route::get('home', 'AlumnosHomeController@informacionPersonal');
        Route::get('informacionPersonal', 'AlumnosHomeController@informacionPersonal');
        Route::get('imagenPerfil', 'AlumnosHomeController@imagenPerfil');
        Route::get('lecciones', 'AlumnosHomeController@lecciones');
        Route::get('miTestimonio', 'AlumnosHomeController@miTestimonio');
        Route::get('sugerencias', 'AlumnosHomeController@sugerencias');
		
        Route::post('actualizarInfoAlumno','AlumnosHomeController@actualizarInfoAlumno');
        Route::post('cambiarImagenPerfil','AlumnosHomeController@cambiarImagenPerfil');
        Route::post('guardarTestimonio','AlumnosHomeController@guardarTestimonio');
        Route::post('guardarSugerencia','AlumnosHomeController@guardarSugerencia');
        Route::post('guardarRating','AlumnosHomeController@guardarRating');

        // Rutas de autentificacion
        /*
		Route::namespace('Auth\Login')->group(function() {
	       Route::get('login', 'AlumnosController@showLoginForm')->name('login');
	       Route::post('login', 'AlumnosController@login')->name('login');
	       Route::get('logout', 'AlumnosController@logout')->name('logout');
        });
        */
});
